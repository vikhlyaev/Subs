...
final class AlertViewController: UITableViewController {
    
    // MARK: - Constants
    
    private enum Constants {
        static let titleText = Localization.alertTitleText
        static let cancelBarButtonText = Localization.alertCancelBarButtonText
    }
    
    // MARK: - Properties
    
    private let viewModel: AlertOutput
    
    // MARK: - Life Cycle
    
    init(viewModel: AlertOutput) {
